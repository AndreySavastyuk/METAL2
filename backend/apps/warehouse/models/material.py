"""
Модели материалов для warehouse приложения
"""
...
class SoftDeleteMixin(models.Model):
    ...
    active_objects = SoftDeleteManager()  # Менеджер только активных записей
...
class MaterialReceipt(AuditMixin):
    ...
    def __str__(self):
        return f"Поступление {self.material.material_grade} - {self.supplier} ({self.material.certificate_number}) - {self.document_number}"

    @property 
    def supplier(self):
        return self.material.supplier if self.material else ""
